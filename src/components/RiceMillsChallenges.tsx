...
const RiceMillsChallenges = () => {
  ...
  return (
    <div className="bg-[#0d2824] text-white min-h-screen flex items-center justify-center pb-12 sm:pb-16 md:pb-10 lg:pb-6 xl:pb-2 2xl:pb-8 pt-4 sm:pt-12 md:pt-4 lg:pt-1 xl:pt-0 2xl:pt-0">
      ...
      <div className="relative w-full h-full max-w-[1450px] mx-auto px-4 sm:px-6 lg:px-2">
        ...
        <div className="hidden lg:block w-full relative">
          ...
          <div className="w-full flex flex-col justify-between">
            ...
            <div className="h-[140px] lg:h-[180px] xl:h-[200px] 2xl:h-[250px] w-[780px] lg:w-[820px] xl:w-[920px] 2xl:w-[900px] mb-20 lg:mb-12 xl:mb-[140px] 2xl:mb-[140px] bg-[#23433E] rounded-2xl p-6 lg:p-6 xl:p-8 2xl:p-10 flex items-center relative overflow-hidden top-16 lg:top-17 xl:top-39 2xl:top-24">
